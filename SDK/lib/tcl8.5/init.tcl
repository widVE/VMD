...
#
# ActiveState ActiveTcl 8.5.13.296436 Win32/x86, Tue Nov 20 02:18:07 PST 2012
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1353406687}
	buildtime,fmt {Tue Nov 20 02:18:07 PST 2012}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.13.296436 Win32/x86 @ Tue Nov 20 02:18:07 PST 2012 / normal}
    }
}

package provide {ActiveTcl} {8.5.13.296436}
