...
#
# $Id: namdplot.tcl,v 1.15 2011/05/31 14:42:02 jim Exp $
#
...
proc ::NAMDPlot::namdparse { namdlogfilename } {
  ...
  while { [gets $infile line] >= 0 } {
    if { [regexp -- "ENERGY:" $line] } {
      ...
      scan $line "TIMING:%d  CPU: %f, %f/step  Wall:%f,%f/step, %f hours remaining, %f %s of memory in use." ts cpusec cpusecstep wallsec wallsecstep hoursremaining meminuse memunit
      set memscale 1.0
