...
#
# (c) 2006-2011 by Axel Kohlmeyer <akohlmey@gmail.com>
########################################################################
#
...
namespace eval ::GofrGUI:: {
    ...
    variable version    "1.2"; # plugin version      
...
proc ::GofrGUI::gofrgui {args} {
    ...
    checkbutton $in.opt.rdf -relief groove -text {Use GPU code} -variable ::GofrGUI::callrdf
    ...
    pack $in.opt.rdf -side left -fill x
    ...
    grid columnconfigure $in.opt.rdf 5 -weight 2 -minsize 10
    ...
    grid config $in.opt  -column 5 -row 0 -columnspan 1 -rowspan 1 -sticky "snew"
    if {$numcuda < 1} {
        $in.opt.rdf configure -state disabled
    }
    ...
    # layout main canvas
    grid configure $w.menubar -column 0 -row 0 -columnspan 1 -rowspan 1 -sticky "new"
    grid configure $w.in -column 0 -row 1 -columnspan 1 -rowspan 1 -sticky "snew"
    grid configure $w.foot  -column 0 -row 2 -columnspan 1 -rowspan 1 -sticky "snew"
