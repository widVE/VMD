...
#    }
	...
	for {set j 0} {$j < [expr $numHops - 1]} {incr j} {
		...
		lset edges2 $currentNetwork $edgeValue $nodeIndex1 $tempIndex2 [expr $currentValue + 1]
	    } else {
		...
		lset edges2 $currentNetwork $edgeValue $nodeIndex2 $tempIndex1 [expr $currentValue + 1]
	    }
	    set nodeIndex1 $nodeIndex2
	}
	if {$nodeIndex2 < $target} {
	    ...
	    lset edges2 $currentNetwork $edgeValue $target $tempIndex2 [expr $currentValue + 1]
	}
	puts "($nodeIndex2,$target)"
    }
