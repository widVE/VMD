...
# 2-D plotting tool
#
# $Id: multiplot.tcl,v 1.38 2012/01/03 18:40:11 gumbart Exp $
#
# Author:
# Jan Saam
# Beckman Institute
...
#                      Four arguments, {x y color marker}, will be passed to the procedure.
...
#   proc click {args} {puts "[lindex $args 3] at x=[lindex $args 0] and y=[lindex $args 1] is colored [lindex $args 2]"}
               ...
               foreach cx $X cy $Y {
		        ...
		        $c bind $item <Any-Enter> "puts \"$cx $cy\""
                     ...
                     if {[lindex $callback $ds]!="none"} {
                        $c bind $item <Any-ButtonPress> "[lindex $callback $ds] $cx $cy $fc [lindex $marker $ds]"
                     }
                  }
               }
            }
