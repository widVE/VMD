##
## $Id: molefacture_gui.tcl,v 1.64 2011/06/17 04:27:15 johanstr Exp $
##
...
#      lappend atomaddlist $index {}
   ...
   $w.menubar.file.menu add command -label "Write psf, prm and pdb files" -command ::Molefacture::write_namdfiles_gui
...
proc ::Molefacture::find_sqm {} {
  set filename [tk_getOpenFile -title "Choose a directory" -initialdir "$::env(HOME)"]
#  puts $filename
