...
##          vmd@ks.uiuc.edu
##
## $Id: biocorepubsync.tcl,v 1.52 2009/01/16 17:09:28 kvandivo Exp $
##
## Home Page:
...
proc ::BiocorePubSync::session_window { } {
    ...
    ::biocore::initDefault "vmdPubSync[package versions biocorepubsync]/[package versions biocore]"
...
#puts "after check_biocore $::biocore::URL"
   ...
   #puts "before the biocorelogin code"
	...
	#puts "after all that code"
	    ...
	    #set errorMessages [::biocore::initDefault] "biocorepubsync [package versions biocorepubsync]"
