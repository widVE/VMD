...
##          vmd@ks.uiuc.edu
##
## $Id: biocorechat.tcl,v 1.41 2009/01/16 17:09:27 kvandivo Exp $
##
## Home Page:
...
# note: need to remove the closing brace on the next line for it to work
#    if { [catch { ::biocore::initDefault "vmdChat" }  anyErrors]  } {}
    if { [catch { ::biocore::initDefault \
          "vmdChat[package versions biocorechat]/[package versions biocore]" }  anyErrors]  } {
	return 0
    } else {
...
# foobar.  how can we have an error window, but no children for .w ?
   ...
   return 0 
	...
	::biocore::initDefault "vmdChat[package versions biocorechat]/[package versions biocore]"
