...
proc ::BioCoREUtil::biocoreutil {} {
  ...
  if {[catch {::biocore::initDefault "biocoreutil[package versions biocoreutil]/[package versions biocore]" } errmsg]} {
     set validUser 0
