...
## Tcl VMD extension
##
## Author: Anssi Nurminen, anssi.nurminen_uta.fi
## University of Tampere - BioMediTech
## 2011-09-28
##
## Recognitions:
## Sampo Kukkurainen, Vesa P. Hytönen, Laurie S. Kaguni
## University of Tampere - BioMediTech
##
##
...
package provide heatmapper 1.0
...
proc ::HeatMapper::InitPlot {args} {
    ...
    namespace eval $new_ns {
        ...
        # Contains keys: title, xlabel, ylabel, xorigin, yorigin
        variable iMapInfo      
        ...
        proc plothandle { aCommand args  } {
            ...
            switch $aCommand {
                ...
                cget { [namespace current]::GetCommandLineArguments $args; return }
                list { [namespace current]::ListCommandLineArguments; return }
...
#        $iW.menubar.help.menu add command -label "Help..." -command "vmd_open_url \"$help_file\""
        ...
        set iMapImage [image create photo -height 100 -width 200 -palette 256/256/256]
        set iBgImage [image create photo -height 370 -width 370 -palette 256/256/256]
        ...
        proc MouseClick { aX aY {aDrag 0} } {
            ...
            set ind_fr [expr (($aX - $origo_x) / $iZoomFactor) + $iMapInfo(xorigin)]
        ...
        proc Refresh { args } {
            ...
            set iMapImage [image create photo -height $map_h -width $map_w -palette 256/256/256]    
