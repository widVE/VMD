...
proc ::QMtool::qmtool_gui {} {
   ...
   menubutton $w.menubar.analysis -text "Analysis" -underline 0 -width 8 \
      -menu $w.menubar.analysis.menu
   menubutton $w.menubar.labels -text "Labels" -underline 0 -width 6 \
      -menu $w.menubar.labels.menu
   ...
   pack $w.menubar.analysis $w.menubar.labels -side left
   pack $w.menubar.help -side right

   # File
   menu $w.menubar.file.menu -tearoff 0
   $w.menubar.file.menu add command -label "Delete molecule" -command {::QMtool::molecule_delete}
   $w.menubar.file.menu add command -label "Reset molecule data" \
      -command {
	 ::QMtool::clear_zmat; 
   ...
   $w.menubar.file.menu add command -label "Reset all" -command {::QMtool::reset_all}


   # File.Open
   menu $w.menubar.file.menu.open -tearoff 0
   $w.menubar.file.menu add cascade -label "Open" -menu $w.menubar.file.menu.open

   set m $w.menubar.file.menu.open
   ...
   # File.Save
   menu $w.menubar.file.menu.save -tearoff 0
   $w.menubar.file.menu add cascade -label "Save" -menu $w.menubar.file.menu.save

   set m $w.menubar.file.menu.save
   ...
   # Edit
   set m $w.menubar.edit.menu
   menu $m -tearoff 0
   $m add command -label "Gaussian input file" -accelerator <Ctrl-g> -command {::QMtool::setup_QM_simulation}
   $m add command -label "Edit Lewis structure in Molefacture" -accelerator <Ctrl-m> \
      -command {::QMtool::molefacture_start}
   $m add separator
   $m add command -label "Atom properties" -accelerator <Ctrl-a> -command {::QMtool::edit_atom_properties}
   $m add command -label "Internal coordinates" -accelerator <Ctrl-i> -command {::QMtool::edit_internal_coords}

   # Analysis
   set m $w.menubar.analysis.menu 
   menu $m -tearoff 0
   $m add command -label "Plot SCF energies" \
      -command {::QMtool::plot_scf_energies} -state disabled
   $m add command -label "Plot spectrum" \
      -command {::QMtool::plot_spectrum} -state disabled
   $m add command -label "Thermochemistry" \
      -command {::QMtool::thermochemistry}
   $m add command -label "Normal mode analysis" \
      -command {::QMtool::normalmode_gui}

   # Labels
   set m $w.menubar.labels.menu
   menu $m -tearoff 0
   $m add checkbutton -label "Internal coordinate tags" -variable ::QMtool::intcoortaglabels \
      -command {::QMtool::update_intcoorlabels}
   $m add checkbutton -label "Internal coordinate atom names" -variable ::QMtool::intcoornamelabels \
      -command {::QMtool::update_intcoorlabels}
   $m add checkbutton -label "Internal coordinate values" -variable ::QMtool::intcoorvallabels \
      -command {::QMtool::update_intcoorlabels}
   $m add checkbutton -label "Force constants" -variable ::QMtool::intcoorfclabels \
      -command {::QMtool::update_intcoorlabels}
   $m add separator
   $m add checkbutton -label "Indices" -variable ::QMtool::Indexlabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "Names" -variable ::QMtool::Namelabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "Types" -variable ::QMtool::Typelabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "User charges" -variable ::QMtool::Chargelabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "Lewis charges" -variable ::QMtool::Lewislabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "Mulliken charges" -variable ::QMtool::Mulliklabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "Mulliken charge groups" -variable ::QMtool::MulliGrlabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "ESP charges" -variable ::QMtool::ESPlabels \
      -command {::QMtool::update_atomlabels}
   $m add checkbutton -label "NPA charges" -variable ::QMtool::NPAlabels \
      -command {::QMtool::update_atomlabels}
   $m add separator
   $m add checkbutton -label "Selected atoms only" -variable ::QMtool::atomlabelselected \
      -command {::QMtool::update_atomlabels}

   # Help
   menu $w.menubar.help.menu -tearoff 0
   $w.menubar.help.menu add command -label "About" \
    -command {tk_messageBox -type ok -title "About QMtool" \
              -message "Graphical interface for Gaussian calculations."}
   $w.menubar.help.menu add command -label "Help..." -command "vmd_open_url [string trimright [vmdinfo www] /]/plugins/qmtool"
