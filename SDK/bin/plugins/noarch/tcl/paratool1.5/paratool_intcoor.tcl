...
#
# $Id: paratool_intcoor.tcl,v 1.19 2011/06/28 02:20:58 saam Exp $
#
...
proc ::Paratool::update_intcoorlist {} {
   ...
   foreach t $zmat {
	 ...
	 foreach i [lindex $t 2] {
	    ...
	    append typelist [format " %6s" $atomtype]
	 }
	 set type [lindex $t 1]
...
proc ::Paratool::set_pickmode_conf {} {
   ...
   mouse mode pick; # "mouse mode addbond" automatically adds bonds
   mouse callback on
