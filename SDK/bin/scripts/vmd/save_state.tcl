...
#       $Revision: 1.44 $        $Date: 2010/02/10 22:39:15 $
#
############################################################################
#
# VMD save state $Revision: 1.44 $
#
#
...
proc save_state {{file EMPTYFILE}} {
  ...
  puts $fildes "\# VMD script written by save_state \$Revision: 1.44 $"
...
proc save_materials { filedes } {
  ...
  for { set i 0 } { $i < [llength $mlist] } { incr i } {
    ...
    lassign [material settings $mat] amb spec dif shin opac outl outlw transmode
