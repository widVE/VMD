  ...
  for (int i=0; i<num; i++) {
    if (flgs[i]) {
      if (strlen(data[i]) == 0) {
        ...
        if (strlen(data[i]) > 1) {
          while (1) {
 if (!_stricmp ((const char *) data[i], "helix")) { c = 'H'; break;}
 if (!_stricmp ((const char *) data[i], "alpha")) { c = 'H'; break;}
 if (!_stricmp ((const char *) data[i], "alpha_helix")) { c = 'H'; break;}
 if (!_stricmp ((const char *) data[i], "alphahelix"))  { c = 'H'; break;}
 if (!_stricmp ((const char *) data[i], "alpha helix")) { c = 'H'; break;}

 if (!_stricmp ((const char *) data[i], "pi"))        { c = 'I'; break;}
 if (!_stricmp ((const char *) data[i], "pi_helix"))  { c = 'I'; break;}
 if (!_stricmp ((const char *) data[i], "pihelix"))   { c = 'I'; break;}
 if (!_stricmp ((const char *) data[i], "pi helix"))  { c = 'I'; break;}

 if (!_stricmp ((const char *) data[i], "310"))       { c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "310_helix")) { c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "3_10"))      { c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "3"))         { c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "310 helix")) { c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "3_10_helix")){ c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "3_10 helix")){ c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "3 10 helix")){ c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "helix_3_10")){ c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "helix 3 10")){ c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "helix3_10")) { c = 'G'; break;}
 if (!_stricmp ((const char *) data[i], "helix310"))  { c = 'G'; break;}

 if (!_stricmp ((const char *) data[i], "beta"))      { c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "betasheet")) { c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "beta_sheet")){ c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "beta sheet")){ c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "sheet"))     { c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "strand"))    { c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "beta_strand"))  { c = 'E'; break;}
 if (!_stricmp ((const char *) data[i], "beta strand"))  { c = 'E'; break;}

 if (!_stricmp ((const char *) data[i], "turn"))  { c = 'T'; break;}

 if (!_stricmp ((const char *) data[i], "coil"))     { c = 'C'; break;}
 if (!_stricmp ((const char *) data[i], "unknown"))  { c = 'C'; break;}
 c = 'X';
 break;
          } // while (1)
        }
   ...
   for (int fragcount=0; fragcount <2; fragcount++) {
	 ...
	 for (int j=0; j<size; j++) {
	    ...
	    if (fragcount == 0) {
         ...
         // PDB names
	       if (!_stricmp ( resname, "GLY")) {*t++ = 'G'; continue;}
	       if (!_stricmp ( resname, "ALA")) {*t++ = 'A'; continue;}
	       if (!_stricmp ( resname, "VAL")) {*t++ = 'V'; continue;}
	       if (!_stricmp ( resname, "PHE")) {*t++ = 'F'; continue;}
	       if (!_stricmp ( resname, "PRO")) {*t++ = 'P'; continue;}
	       if (!_stricmp ( resname, "MET")) {*t++ = 'M'; continue;}
	       if (!_stricmp ( resname, "ILE")) {*t++ = 'I'; continue;}
	       if (!_stricmp ( resname, "LEU")) {*t++ = 'L'; continue;}
	       if (!_stricmp ( resname, "ASP")) {*t++ = 'D'; continue;}
	       if (!_stricmp ( resname, "GLU")) {*t++ = 'E'; continue;}
	       if (!_stricmp ( resname, "LYS")) {*t++ = 'K'; continue;}
	       if (!_stricmp ( resname, "ARG")) {*t++ = 'R'; continue;}
	       if (!_stricmp ( resname, "SER")) {*t++ = 'S'; continue;}
	       if (!_stricmp ( resname, "THR")) {*t++ = 'T'; continue;}
	       if (!_stricmp ( resname, "TYR")) {*t++ = 'Y'; continue;}
	       if (!_stricmp ( resname, "HIS")) {*t++ = 'H'; continue;}
	       if (!_stricmp ( resname, "CYS")) {*t++ = 'C'; continue;}
	       if (!_stricmp ( resname, "ASN")) {*t++ = 'N'; continue;}
	       if (!_stricmp ( resname, "GLN")) {*t++ = 'Q'; continue;}
	       if (!_stricmp ( resname, "TRP")) {*t++ = 'W'; continue;}
         // CHARMM names
         if (!_stricmp ( resname, "HSE")) {*t++ = 'H'; continue;}
         if (!_stricmp ( resname, "HSD")) {*t++ = 'H'; continue;}
         if (!_stricmp ( resname, "HSP")) {*t++ = 'H'; continue;}
         // AMBER names
         if (!_stricmp ( resname, "CYX")) {*t++ = 'C'; continue;}
	    } else {
	       // nucleic acid translations
	       if (!_stricmp ( resname, "ADE")) {*t++ = 'A'; continue;}
	       if (!_stricmp ( resname, "A")) {*t++ = 'A'; continue;}
	       if (!_stricmp ( resname, "THY")) {*t++ = 'T'; continue;}
	       if (!_stricmp ( resname, "T")) {*t++ = 'T'; continue;}
	       if (!_stricmp ( resname, "CYT")) {*t++ = 'C'; continue;}
	       if (!_stricmp ( resname, "C")) {*t++ = 'C'; continue;}
	       if (!_stricmp ( resname, "GUA")) {*t++ = 'G'; continue;}
	       if (!_stricmp ( resname, "G")) {*t++ = 'G'; continue;}
               if (!_stricmp ( resname, "URA")) {*t++ = 'U'; continue;}
               if (!_stricmp ( resname, "U")) {*t++ = 'U'; continue;}
	    }
	    // then I have no idea
	    *t++ = 'X';
